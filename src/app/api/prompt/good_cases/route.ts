// src/app/api/prompt/good_cases/route.ts
...
export const POST = withUser(async (req: NextRequest, userId: string) => {
    ...
    const created = await repo.insertGoodCases(prompt_id, items, userId);
...
export const PUT = withUser(async (req: NextRequest, userId: string) => {
    ...
    const updated = await repo.updateGoodCases(items, userId);
...
export const DELETE = withUser(async (req: NextRequest, userId: string) => {
    ...
    await repo.deleteGoodCases(ids, userId);
